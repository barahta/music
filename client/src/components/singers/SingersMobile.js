            ...
            >
                <div className={style.listblock}>
                    <div
                        ...
                        style={{
                            transform: `translateX(-${currentIndex * (slideWidth + 36)}px)`, // Смещение слайдов
